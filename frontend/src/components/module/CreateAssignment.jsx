...
export default function CreateAssignment(props) {
    ...
    const createAssignmentForm = [
        ...
        {type: "text", name: "title", colSpan: "col-span-4", label: "Module Title", required: true, placeholder: "Module Title", id: "id" },
        ...
        {type: "checkbox", name: "is_coding", colSpan: "col-span-1", label: "Is Coding", placeholder: "placeholder", id: "checkbox9", cols: "grid-cols-1", ref: fromVisi, options: [{value: "Is coding", defaultChecked:{codeFormVisibility}}] },
        
        {type: "number", name: "code_compilation_score", colSpan: "col-span-2", label: "compilation_score", placeholder: "compilation_score", id: "id" },
        {type: "number", name: "code_running_score", colSpan: "col-span-2", label: "running_score", placeholder: "running_score", id: "id" },
        {type: "number", name: "code_test_cases_score", colSpan: "col-span-2", label: "test_cases_score", placeholder: "test_cases_score", id: "id" },
        {type: "number", name: "code_final_cases_score", colSpan: "col-span-2", label: "final_cases_score", placeholder: "final_cases_score", id: "id" },
        ...
        {type: "code", name: "imports_code", colSpan: "col-span-4", label: "Import Libraries", placeholder: "// Import Libraries here below this line", id: "id", resize: "true", ref: codeSyntax},
        {type: "code", name: "user_code", colSpan: "col-span-4", label: "Function difinition for students", placeholder: "// Give function definition for solution", id: "id", resize: "true", ref: codeFunctionDef},
        {type: "code", name: "solution_code", colSpan: "col-span-4", label: "Write your solution and test cases", placeholder: "// Import Libraries here below this line", id: "id", resize: "true", ref: codeSolution},
                    ...
                    <div className="mx-automax-w-7xl py-6 px-1 sm:px-6 lg:px-8">
                        <div className='flex items-center flex-col'>
                            <div className='grid grid-cols-3 gap-5'>
                                {/* <FormGenerator inputs={createGroupForm} handleSubmit={handleSubmit} cols=" grid-cols-2 col-span-2">

                                </FormGenerator> */}
                                {/* <FormGenerator inputs={updateGroupForm} handleSubmit={handleSubmit} cols=" grid-cols-2">
                                ...
                                {/* {   codeFormVisibility ? 
                                        (<FormGenerator heading="Design a coding problem" inputs={codingForm} handleSubmit={handleSubmit} cols=" grid-cols-1 col-span-3"> </FormGenerator>) : ""
                                } */}
